...
export const Footer: FC<FooterProps> = observer(({ testID = "Footer" }) => {
  const { app } = useStore()
...
const styles = StyleSheet.create({
  rootFooter: tw(
    `flex-row flex-no-wrap overflow-hidden justify-between ${theme.bgFooter} inset-x-0 bottom-0 px-2 h-8 items-center`
  ),
